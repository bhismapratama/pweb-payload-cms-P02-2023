...
<template>
  <table>
    <thead class="bg-gray-100 border-b-2 border-gray-300">
      <tr>
        <th class="p-1 text-sm font-bold tracking-wide">Check</th>
        <th class="p-3 text-sm font-bold tracking-wide">Category</th>
        <th class="p-1 text-sm font-bold tracking-wide">Title</th>
        <th class="p-1 text-sm font-bold tracking-wide">Date</th>
        <th class="p-1 text-sm font-bold tracking-wide">Actions</th>
      </tr>
    </thead>
    <tbody>
      <tr class="border-b" v-for="todo in todoStore.todos" :key="todo.id">
        ...
        <th class="p-3 text-sm text-gray-700 font-normal" id="cate">
          <span
            :style="{
              'text-decoration': todo.isChecked ? 'line-through' : 'none',
            }"
          >
            {{ todo.category }}
          </span>
